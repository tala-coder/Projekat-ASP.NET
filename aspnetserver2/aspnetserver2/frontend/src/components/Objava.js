...
const Objava = ({ naslov_oglasa, naziv_firme, lokacija, iskustvo, opis, apliciraj_link, postId, slika_firme }) => {
        ...
        <Container>
            <Row className="justify-content-md-start border border-dark mt-1"  >
                ...
                <Col xs lg="2" className="justify-content-end">
                    <Button className="mt-3" variant="outline-primary" onClick={() => redirect(apliciraj_link)} >Apliciraj</Button>
                </Col>
